namespace Loupedeck.AgentDeckPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.AgentDeckPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.AgentDeckPlugin.Resources.Resource.txt`.
